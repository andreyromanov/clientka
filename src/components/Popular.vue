<template>
    <div style="background-color: lightblue">
        <div class="container border-top py-md-5">
            ...
            <vueper-slides class="no-shadow" :visible-slides="4" slide-multiple :gap="3" :slide-ratio="1 / 4" :dragging-distance="200" :breakpoints="{ 800: { visibleSlides: 2, slideMultiple: 2 } }">
